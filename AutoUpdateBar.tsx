      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3 text-sm">
            ...
            <div>
              <div className="flex flex-wrap items-center gap-2">
                <span className="font-black text-white text-xs sm:text-sm font-display flex items-center gap-1.5">
                  Sincronização Oficial SINE-PI & Vagas Teresina
                </span>
              ...
              <p className="text-[11px] text-slate-300 font-medium">
                {isAutoUpdating ? (
                  <>Verificação automática ativa • Vagas auditadas do Boletim Oficial • Checado: {lastUpdated}</>
                ) : (
                  <>Radar em pausa • Clique para reativar sincronização</>
                )}
              </p>
            </div>
          </div>
        ...
        {isAutoUpdating && (
          <div className="hidden lg:flex items-center gap-2.5 px-3 py-1 rounded-xl bg-slate-800 border border-slate-700">
            <span className="text-xs text-slate-300 font-bold">Próxima checagem:</span>
        ...
        <div className="flex items-center gap-2 w-full md:w-auto justify-end">
          ...
          >
            ...
            <span>{isRefreshing ? 'Sincronizando com SINE-PI...' : 'ATUALIZAR AGORA'}</span>
          </button>
        </div>
